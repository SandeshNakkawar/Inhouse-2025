...
const StudentCard = ({ student, onClick }) => {
  return (
    <Card
      className="transition-colors duration-200 cursor-pointer bg-white hover:bg-[#155E95] hover:text-white"
      onClick={() => onClick(student)}
    >
      <CardContent className="pt-6">
        <div className="flex flex-col items-center text-center">
          <div className="h-16 w-16 rounded-full bg-blue-100 hover:bg-white flex items-center justify-center mb-4 transition-colors duration-800">
            <UserCircle className="h-10 w-10 text-[#155E95] hover:text-[#155E95]" />
          </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <p className="font-medium">{batch?.subjectName || 'Not specified'}</p>
            </div>
          </div>
        </CardContent>
      </Card>
